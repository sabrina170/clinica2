                                        ...
                                        <tbody>
                                            ...
                                            if (!$resultado) {
                                                ...
                                                while ($data = mysqli_fetch_assoc($resultado)) {
                                                    ...
                                                    echo '
                                                <tr class="venta_item" data-ide="' . $data['id_paciente'] . '">
                                                <td class="pt-8 pb-8 pl-16 pr-16"><p>' . $data['id_paciente'] . '</td>
                                                <td class="pt-8 pb-8 pl-16 pr-16"><img src="' . $data['galeria'] . '" width="35" height="35" style="border-radius:50%; object-fit:cover;"></td>
                                                <td class="pt-8 pb-8 pl-16 pr-16"><a href="page-detalle-historia.php?ide=' . $data['id_paciente'] . '"><p>' . $data['cod_receta'] . '</p></a></td>
                                                <td class="pt-8 pb-8 pl-16 pr-16"><p>' . $data['pac_nombre'] . '</td>
                                                <td class="pt-8 pb-8 pl-16 pr-16"><p>' . $data['pac_apellido'] . '</td>
                                                <td class="pt-8 pb-8 pl-16 pr-16"><p>' . $data['create_at'] . '</td>
                                                </tr>';
