                    ...
                    <div id="panel-dashboard">
                        <form id="frm_add_producto" class="data-grid-3 frm_object" enctype="multipart/form-data">
                            <div class="ed-container full" style="padding:15px;">
                                <input type="text" id="titulo-entrada" placeholder="Agregar titulo" class="form-control ob font-weight-bold font-36 border-0">
                                <p name="descripcion_producto" class="editable mt-20 border-0" id="contenido-entrada" contenteditable="true" style="border: 1px solid rgb(204, 204, 204); min-height: 170px; width: 100%; margin: 0px;padding: 15px;overflow: auto;position: relative;" class="txt-frm ">Ingrese un texto</p><br>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <article class="">
                        ...
                        <div class="cnt-upload position-relative">
                            <div id="cnt-img-nosotros">
                                <img class="item-upload-img" id="img_entrada" src="../assets/img/placeholder.jpg" width="70%">
                            </div>
...
<script>
    ...
    function agregar_entrada(campo) {
