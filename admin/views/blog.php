...
$consulta_entradas = "SELECT * FROM blog";
$consulta_categorias = "SELECT * FROM blog_categorias";





$resultado_entradas = mysqli_query($cn, $consulta_entradas);
...
if (!$resultado_entradas) {
    ...
    $arreglo = [];
    while ($data = mysqli_fetch_assoc($resultado_entradas)) {
        $arreglo["data"][] = array_map("utf8_encode", $data);
    }
    $entradas = json_encode($arreglo);
}
?>
        ...
        <div class="row m-t-20">
            ...
            <div class="col-lg-9">
                <div class="bg-white p-24 br-8">
                    ...
                    <h2>Lista de entradas
                    <a href="page-agregar-entrada.php" class="btn btn-success float-right mr-16"><i class="fas fa-plus"></i> Agregar Entrada</a>
                </h2>
                <hr>
                        <div id="panel-dashboard">
                            ...
                            <div id="view-productos" class="view-tab">
                                <table id="td_blog" class="" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th>Código</th>
            ...
            <div class="col-lg-3">
                <div class="bg-white p-24 br-8">
                    ...
                    <h2 class="mt-24">Lista de categorias</h2>
                    <hr>
                    <table class="table">
                            ...
                            while ($data = mysqli_fetch_assoc($resultado_categorias)) {
                                ...
                                echo '<tr><td>' . $data['nombre_categoria'] . '</td><td><button data-name="' . $data['nombre_categoria'] . '" data-ide="' . $data['id_categoria'] . '" class="btn btn-warning btn-sm btn-edit"><i class="far fa-edit"></i></button><button data-ide="' . $data['id_categoria'] . '" class="btn btn-danger btn-sm ml-12 delete-cate"><i class="far fa-trash-alt"></i></button></td></tr>';
                            } ?>
    ...
    $('#td_blog').DataTable({
        ...
        { data: 'estado_entrada' },
        {
            render: function(data, type, row) {
                return "<a class='editar btn t-active btn-sm' href='page-editar-entrada.php?entrada="+ row['id_entrada'] +"'><i class='far fa-edit'></i></a><a href='#' data-ide="+ row['id_entrada'] +" class='btn t-inactive btn-sm eliminar btn-delete-entrada'><i class='far fa-trash-alt'></i></a>"
            }
        }
    ]
    });
