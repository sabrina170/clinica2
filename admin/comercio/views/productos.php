                        ...
                        <div id="panel-dashboard">
                            <div id="view-productos" class="view-tab">
                                <h2>Administrar Productos
                                    ...
                                    <a href="page-productos-planilla.php" class="btn t-active float-right"><i class="fas fa-plus"></i> Agregar planilla de productos</a>
                                    <a href="page-agregar-producto-neg.php" class="btn t-active float-right mr-16"><i class="fas fa-plus"></i> Agregar producto</a>
        ...
        columns: [{
            ...
            },
            {
                render: function(data, type, row) {
                    return "<a class='editar btn t-active btn-sm' href='page-editar-producto-neg.php?ide=" + row['id_producto'] + "'><i class='far fa-edit'></i></a><a href='#' data-ide=" + row['id_producto'] + " class='btn t-inactive btn-sm eliminar btn-delete-producto'><i class='far fa-trash-alt'></i></a>"
                }
            }
        ]
